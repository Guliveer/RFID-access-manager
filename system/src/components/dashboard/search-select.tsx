...
export function SearchSelect({ value, onChange, options, placeholder = "Select...", emptyMessage = "No results found", searchPlaceholder = "Search...", maxResults = 50, icon, className = "" }: SearchSelectProps) {
...
export function UserSearchSelect({ users, value, onChange, placeholder = "Search users by name or email...", className = "" }: UserSearchSelectProps) {
...
export function ScannerSearchSelect({ scanners, value, onChange, placeholder = "Search scanners by name or location...", className = "" }: ScannerSearchSelectProps) {
  const options: SearchSelectOption[] = useMemo(
    () =>
