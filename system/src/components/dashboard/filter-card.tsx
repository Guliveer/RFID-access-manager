...
export function FilterCard({ children, title = "Filters", className = "" }: FilterCardProps) {
  return (
...
export function FilterSelect({ value, onChange, options, placeholder, className = "w-[140px]" }: FilterSelectProps) {
  return (
...
export function ClearFiltersButton({ onClick, show, variant = "default", className = "" }: ClearFiltersButtonProps) {
  if (!show) return null;
